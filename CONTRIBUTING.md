...
```bash
$ git clone --recursive git@github.com:mediasoftpro/videoengine.git videoengine
```

This will clone your fork to your current path in a directory named videoengine.
...
You should also set up the upstream repository. This will allow you to take changes from the "master" repository and merge them into your local clone and then push them to your GitHub fork:
    ...
    $ cd videoengine
    $ git remote add upstream git@github.com/mediasoftpro/videoengine.git
    $ git fetch upstream
